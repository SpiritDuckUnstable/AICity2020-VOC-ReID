...
# MODEL.NAME "('resnet50')" \
# MODEL.PRETRAIN_PATH "('/data/zhuang39/AICity2020-VOC-ReID/pre_models/resnet50-19c8e357.pth')" \
...
MODEL.PRETRAIN_PATH "('/data/zhuang39/AICity2020-VOC-ReID/pre_models/resnet50_ibn_a.pth')" \
MODEL.ID_LOSS_TYPE 'circle' \
SOLVER.COSINE_MARGIN 0.35 \
SOLVER.COSINE_SCALE 64 \
MODEL.POOLING_METHOD 'GeM' \
...
DATASETS.TEST "('veri',)" \
DATASETS.ROOT_DIR "('/data/zhuang39/AICity2020-VOC-ReID/datasets')" \
OUTPUT_DIR "('./output/veri/size320')"